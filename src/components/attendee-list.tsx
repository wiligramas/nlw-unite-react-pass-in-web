                    ...
                    <table className='w-full'>
                        <thead>
                            <tr className='border-b border-white/10'>
                                ...
                                <th className='py-3 px-4 text-sm font-semibold text-left'>Data do chekin-in</th>
                                ...
                                return(
                                    <tr key={i} className='border-b border-white/10 hover:bg-white/5'>
                                        ...
                                        <div className='flex flex-col gap-1'>
                                            <span className='font-semibold text-white'>William Carlos Dos Santos Varela</span>
                                            <span>wiligramasdev@gmail.com</span>
                                        </div>
                                        </td>
