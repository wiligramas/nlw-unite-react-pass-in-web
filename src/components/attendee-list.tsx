import {/*Importações dos botões tras e frente*/
    ChevronLeft,
    ChevronRight,
    ChevronsLeft,
    ChevronsRight,
  ...
  import dayjs from "dayjs";/*Extenção para formatar a data e hora */
    ...
    return (
      <div className="flex flex-col gap-4">
        ...
        <Table>
          ...
          <tbody>
            {/*Começar a percorrer da pagina 1 até 10 e acrescentar mais des para paginas seguintes*/}
          ...
          <tfoot>
            <tr>
                {/*Mostrando o Tamanho maximo das paginas*/}
              <TableCell colSpan={3}>
